    ...
    <div className="relative min-h-[92vh] flex flex-col items-center justify-center p-4 selection:bg-[#FF3B30] selection:text-white">
      <div className="w-full max-w-xl text-center z-10 my-auto">
        ...
        <div className="space-y-6 select-none border-4 border-black p-12 bg-white shadow-[8px_8px_0px_0px_#000000]">
          <div className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-white border-2 border-black text-2xs font-mono tracking-[0.2em] text-black font-bold mb-4">
          ...
          <div className="flex flex-col items-center gap-5 pt-4">
            ...
            <div className="w-full flex items-center gap-3">
              ...
              <span className="text-2xs font-mono text-neutral-600 uppercase tracking-[0.2em] font-bold">or</span>
              <div className="flex-1 h-0 border-t-2 border-black" />
            </div>
          ...
          {/* Feature badges */}
          <div className="flex justify-center items-center gap-6 text-2xs font-mono uppercase tracking-[0.2em] text-neutral-600 select-none pt-6 border-t-2 border-black mt-8">
      ...
      <div className="mt-auto text-2xs font-mono text-neutral-600 tracking-widest uppercase pt-8 font-bold">
