...
export const Navbar: React.FC = () => {
  ...
  return (
    <nav className="w-full bg-black/80 backdrop-blur-xl border-b border-neutral-900 sticky top-0 z-40 px-6 py-4 shadow-[0_1px_20px_rgba(0,0,0,0.8)]">
        ...
        {isLegalPage ? (
          ...
          <div className="flex items-center gap-6">
              ...
              {currentPage === 'admin' ? (
                ...
                user.role === 'admin' && (
                  <button
                    ...
                    className="text-[10px] font-mono font-bold text-black flex items-center gap-1.5 px-3.5 py-1.5 bg-white border border-white rounded-sm hover:bg-neutral-200 transition-all cursor-pointer uppercase tracking-wider shadow-[0_0_12px_rgba(255,255,255,0.15)] hover:shadow-glow-white active:scale-95"
                  >
            ...
            <div className="flex items-center gap-3 border-l border-neutral-900 pl-4">
              ...
              {/* Avatar */}
              <div className="h-8 w-8 rounded-full bg-neutral-950 border border-neutral-800 hover:border-accent/40 flex items-center justify-center text-xs font-bold text-white font-mono uppercase tracking-widest relative cursor-default select-none transition-colors shadow-inner">
