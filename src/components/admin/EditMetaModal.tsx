    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/90">
      <div className="w-full max-w-md bg-white border-3 border-black p-6 shadow-[8px_8px_0px_0px_#000000] relative text-left">
        ...
        <div className="flex items-center gap-3 mb-5">
          ...
          <div><h3 className="text-black font-display font-bold tracking-wider text-sm uppercase">REDEFINE ASSET PREFERENCES</h3><p className="text-xs font-mono text-neutral-700 font-bold">MANAGE SECTION OR DEPLOY FLAG</p></div>
        </div>
        <form onSubmit={handleMetaSubmit} className="space-y-4">
            <div>
              <label className="block text-xs font-mono text-black font-bold uppercase mb-1.5 tracking-wider">Asset Location Section</label>
            ...
            <div>
              <label className="block text-xs font-mono text-black font-bold uppercase mb-1.5 tracking-wider">Course</label>
          ...
          <div className="flex items-center justify-between p-3.5 bg-white border-2 border-black select-none">
            <div><div className="text-xs font-bold text-black">PUBLISH TO SYSTEM</div><div className="text-xs font-mono text-neutral-700 font-bold uppercase tracking-tight mt-0.5">Students can preview or download</div></div>
