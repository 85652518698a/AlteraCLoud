  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'card-hover': '0 8px 32px rgba(0,0,0,0.8), 0 0 20px rgba(34,211,238,0.06)',
        modal: '0 24px 64px rgba(0,0,0,0.9)',
        elevated: '0 4px 24px rgba(0,0,0,0.8)',
        'glow-brand': '0 0 20px rgba(34,211,238,0.15)',
        'glow-white': '0 0 24px rgba(255,255,255,0.1)',
      },
      animation: {
      ...
      keyframes: {
        ...
        glowPulse: {
          '0%, 100%': { boxShadow: '0 0 12px rgba(34,211,238,0.06)' },
          '50%': { boxShadow: '0 0 24px rgba(34,211,238,0.15)' },
        },
        shimmer: {
